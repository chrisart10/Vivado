...
HD_PWD='C:/Users/cristian/proyecto/proyecto.runs/ADD8bit1_ADD1_0_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADD8bit1_ADD1_0_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADD8bit1_ADD1_0_7.tcl
