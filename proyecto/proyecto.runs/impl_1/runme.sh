...
HD_PWD='C:/Users/cristian/proyecto/proyecto.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADD8bit1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADD8bit1_wrapper.tcl -notrace
