...
HD_PWD='C:/Users/cristian/proyecto/proyecto.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADD8bit1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADD8bit1_wrapper.tcl
