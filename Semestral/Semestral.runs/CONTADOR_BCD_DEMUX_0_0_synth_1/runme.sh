...
HD_PWD='C:/Users/cristian/Semestral/Semestral.runs/CONTADOR_BCD_DEMUX_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CONTADOR_BCD_DEMUX_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CONTADOR_BCD_DEMUX_0_0.tcl
