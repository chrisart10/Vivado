...
HD_PWD='C:/Users/cristian/Semestral/Semestral.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CONTADOR_BCD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CONTADOR_BCD_wrapper.tcl -notrace
