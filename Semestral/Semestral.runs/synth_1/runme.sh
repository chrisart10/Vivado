...
HD_PWD='C:/Users/cristian/Semestral/Semestral.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CONTADOR_BCD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CONTADOR_BCD_wrapper.tcl
